 ...
 * to orange as it nears the decision — so colour tracks progression, not decoration.
 * Enrolled lands on green, the one stage that means the lead is now a student.
 */
